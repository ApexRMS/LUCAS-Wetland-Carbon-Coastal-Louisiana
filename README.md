...
## Suggested Workflow
1. __Download SyncroSim:__ SyncroSim v3.1.14 can be downloaded at: https://syncrosim.com/download/.
2. __Install R and rsyncrosim:__ Install R, then install rsyncrosim v2.1.9 from GitHub using this tutorial: https://syncrosim.github.io/rsyncrosim/articles/a06_rsyncrosim_install_github.html.
