...
## Dependencies
The scripts in this repository were built using SyncroSim v3.1.30, with the following SyncroSim packages: ST-Sim v4.5.3, using R v4.6.0 with the following R packages rsyncrosim v2.1.13, tidyverse v2.0.0, terra v1.9-25, sf v1.1-1, and viridis v0.6.5.

## Suggested Workflow
1. __Download SyncroSim:__ SyncroSim v3.1.30 can be downloaded at: https://syncrosim.com/download/.
