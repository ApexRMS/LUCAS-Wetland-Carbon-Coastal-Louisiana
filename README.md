...
## Dependencies
The scripts in this repository were built using SyncroSim v3.1.24, with the following SyncroSim packages: ST-Sim v4.5.3, using R v4.5.2 with the following R packages rsyncrosim v2.1.11, tidyverse v2.0.0, terra v1.8-70, sf v1.0-21, and viridis v0.6.5.

## Suggested Workflow
1. __Download SyncroSim:__ SyncroSim v3.1.24 can be downloaded at: https://syncrosim.com/download/.
2. __Install R and rsyncrosim:__ Install R, then install rsyncrosim v2.1.11 from GitHub using this tutorial: https://syncrosim.github.io/rsyncrosim/articles/a06_rsyncrosim_install_github.html.
